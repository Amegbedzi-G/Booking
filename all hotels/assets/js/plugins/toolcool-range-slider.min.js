...
(() => {
    ...
    var St = (r, i) =>
        ` ${
      i && i.length > 0
        ? i.map((t) => `<link rel="stylesheet" href="${t}" />`).join("")
        : ""
    } <style> ${r} </style> <div class="range-slider-box"> <div class="row"> <div id="range-slider" class="range-slider"> <div class="container"> <div class="panel"></div> <div class="panel-fill"></div> <div class="container"> <div class="pointer" tabindex="0" role="slider"> <div class="pointer-shape"></div> </div> </div> </div> </div> </div> </div>`;
    var Tt =
    ...
    var Jt = (r) => {
        ...
        i ?
        i.findIndex(
            (t) => t === r || t.toString().trim() === r.toString().trim()
        ) :
        -1;
    var _t = (r) => ({
        updatePosition: (t, n, s, d) => {
            ...
            t === I ?
                (r.style.removeProperty("width"),
                    ...
                    m ?
                    (r.style.height = `${l}%`) :
                    (r.style.height = `${Math.abs(l - a)}%`),
                    d ?
                    ((r.style.bottom = "0%"),
                        m ?
                        (r.style.top = "auto") :
                        (r.style.top = `${Math.min(100 - a, 100 - l)}%`)) :
                    ((r.style.bottom = "auto"),
                ...
                (r.style.removeProperty("height"),
                    ...
                    m ?
                    (r.style.width = `${l}%`) :
                    (r.style.width = `${Math.abs(l - a)}%`),
                    s ?
                    ((r.style.right = "0%"),
                        m ?
                        (r.style.left = "auto") :
                        (r.style.left = `${Math.min(100 - a, 100 - l)}%`)) :
                    ((r.style.right = "auto"),
                        m ?
                        (r.style.left = "0%") :
                        (r.style.left = `${Math.min(l, a)}%`)));
        },
    });
        ...
        xn = (r, i, t) => {
            let n = null,
                ...
                a = (c) => {
                    (n = c),
                    m("theme-"),
                        typeof c == "string" && i.classList.add(`theme-${c}`);
                },
                f = () => {
                    if ((l(), !(s.length <= 0))) {
    ...
    var Pn = (r, i, t, n) => {
        let s = [],
            ...
            l = (p, b) => {
                for (let T of s)
                    T.onAttrChange &&
                    typeof T.onAttrChange == "function" &&
                    T.onAttrChange(p, b);
            },
            a = (p) => {
    ...
    var Yn = 10,
        ...
        tt = (r, i, t, n, s, d, m) => {
            try {
                Object.defineProperty(r, n, {
                        ...
                        set: (l) => {
                            i.pointers[t] ?
                                i == null || i.setValue(l, t) :
                                i == null || i.addPointer(l);
                        },
                    }),
                    ...
                    Object.defineProperty(r, d, {
                        ...
                        get() {
                            var l, a;
                            return (a =
                                    (l = i == null ? void 0 : i.styles) == null ?
                                    void 0 :
                                    l.pointerShapes[t]) != null ?
                                a :
                                null;
                        },
                        set: (l) => {
                    ...
                    Object.defineProperty(r, m, {
                        ...
                        get() {
                            var l;
                            return (l = i == null ? void 0 : i.pointers[t].disabled) != null ?
                                l :
                                !1;
                        },
                        set: (l) => {
        ...
        nt = (r, i, t) => {
            var s;
            let n =
                (s = t.shadowRoot) == null ? void 0 : s.querySelector(".container");
            if (!!n)
                for (let d of r) i ? n.prepend(d.$pointer) : n.append(d.$pointer);
        },
        An = (r, i) => {
            if (!(!i || r.length <= 1)) {
            ...
            let n = t.map((e) => e[0]),
                ...
                Vn = () => {
                    ...
                    for (let u = 0; u < n.length; u++) {
                        ...
                        y.setAttr(
                                "aria-valuemin",
                                ((e = On(u)) != null ? e : "").toString()
                            ),
                            y.setAttr(
                                "aria-valuemax",
                                ((o = Bn(u)) != null ? o : "").toString()
                            );
                    }
                },
                te = (e) => {
                ...
                Ge = (e) => {
                    var y;
                    typeof e == "string" ?
                        (b = e.trim().toLowerCase() === I ? I : V) :
                        (b = V);
                    let o =
                        (y = r.shadowRoot) == null ?
                        void 0 :
                        y.querySelector(".range-slider-box");
                    if (!o) return;
                ...
                Un = () => {
                    qe(D(r.getAttribute(Pe))),
                        (k = D(r.getAttribute(Ee))),
                        (F = D(r.getAttribute(Se)));
                ...
                Wn = (e) => {
                    ...
                    let M = Y(r, y, o);
                    return (
                        M.setCallbacks(lt, ut, dt, ct), n.push(M), re(e, o), N(), W(), o
                    );
                },
                Kn = () => {
                    let e = n.length,
                        o = n[e - 1];
                    return o ?
                        (o.destroy(), n.pop(), n.length <= 1 && oe(!1), N(), W(), e - 1) :
                        -1;
                };
            return (
                (() => {
                    ...
                    e && (d = _t(e)),
                        ...
                        F || document.addEventListener("wheel", Q, {
                            passive: !1
                        }),
                        (l = Pn(
                            r,
    ...
    var Dn = (r, i, t) => {
        let n = $e.find(
            ([l, a, f, x]) => a.replace("#", "") === i.replace(/\d+/g, "")
        );
        if (n && r.styles) {
            let [l, a, f, x] = n,
        ...
        if (
            (/^value([0-9]*)$/.test(i) && (s = "value"),
                ...
                /^pointer([0-9]*)-shape$/.test(i) && (s = "pointer-shape"), !s)
        )
            return;
    ...
    var it = class extends HTMLElement {
            ...
            get disabled() {
                var t, n;
                return (n = (t = this.slider) == null ? void 0 : t.disabled) != null ?
                    n :
                    !1;
            }
            set data(t) {
            ...
            get round() {
                var t, n;
                return (n = (t = this.slider) == null ? void 0 : t.round) != null ?
                    n :
                    U;
            }
            set type(t) {
            ...
            get pointersOverlap() {
                var t, n;
                return (n = (t = this.slider) == null ? void 0 : t.pointersOverlap) !=
                    null ?
                    n :
                    !1;
            }
            ...
            get pointersMinDistance() {
                var t, n;
                return (n =
                        (t = this.slider) == null ? void 0 : t.pointersMinDistance) != null ?
                    n :
                    0;
            }
            ...
            get pointersMaxDistance() {
                var t, n;
                return (n =
                        (t = this.slider) == null ? void 0 : t.pointersMaxDistance) != null ?
                    n :
                    1 / 0;
            }
            set theme(t) {
            ...
            get theme() {
                var t, n, s;
                return (s =
                        (n = (t = this.slider) == null ? void 0 : t.styles) == null ?
                        void 0 :
                        n.theme) != null ?
                    s :
                    null;
            ...
            get rtl() {
                var t, n;
                return (n = (t = this.slider) == null ? void 0 : t.rightToLeft) != null ?
                    n :
                    !1;
            }
            set btt(t) {
            ...
            get btt() {
                var t, n;
                return (n = (t = this.slider) == null ? void 0 : t.bottomToTop) != null ?
                    n :
                    !1;
            }
            ...
            get keyboardDisabled() {
                var t, n;
                return (n = (t = this.slider) == null ? void 0 : t.keyboardDisabled) !=
                    null ?
                    n :
                    !1;
            }
            ...
            get mousewheelDisabled() {
                var t, n;
                return (n =
                        (t = this.slider) == null ? void 0 : t.mousewheelDisabled) != null ?
                    n :
                    !1;
            }
            ...
            get rangeDragging() {
                var t, n;
                return (n = (t = this.slider) == null ? void 0 : t.rangeDragging) !=
                    null ?
                    n :
                    !1;
            }
            ...
            addPointer(t) {
                ...
                let n =
                    (d = (s = this.slider) == null ? void 0 : s.addPointer(t)) != null ?
                    d :
                    0;
                tt(
                    this,
            ...
            connectedCallback() {
                ...
                let t =
                    (d = this.shadowRoot) == null ? void 0 : d.querySelector(".pointer");
                if (!t) return;
                let n =
                    (m = this.shadowRoot) == null ?
                    void 0 :
                    m.getElementById("range-slider");
                if (!n) return;
                let s = Sn(this, t);
                ...
                Tn(this, this.slider),
                    (this._observer = new MutationObserver((l) => {
                        l.forEach((a) => {
                            ...
                            !f ||
                                Dn(this.slider, f, (x = this.getAttribute(f)) != null ? x : "");
                        });
                    })),
